...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <h1>Bạn đang trên xe số <?php echo $_GET['idbus'];?>!</h1>
                <button id="Done" class="btn btn-success btn-lg">Thanh toán</button>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            $('#Done').click(function(){
                location.href = "Control/ThanhToan.php" + location.search;  
            });
        });
    </script>
</html>
