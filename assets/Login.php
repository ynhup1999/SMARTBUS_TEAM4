...
<div class="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand">Đăng Nhập</a>
                </div>
                                ...
                                <div class="form">
                                    ...
                                    <div class="row">
										...
										<div class="col-md-3 col-md-offset-3">
											<button id="btn-login" type="submit" class="btn btn-success">Đăng nhập</button></button>
                                            <a href="Register.php" id="btn-login" type="submit" class="btn btn-error">Đăng ký</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="Control/LoginScript.js"></script>
</html>
